...
%  The algorithm from [2] based on Green's theorem is used to compute f.


function [f]=cdf_polyhedron_green(S,P,d,n,Crossing_Number,AreaP)
...
if (Nb_Intersections>0)
    ...
    if (AreaInter==AreaP) 
        f=1;
    elseif (mod(Crossing_Number,2)==1) 
        f=((pi)*(d^2))/AreaP;
    else
        f=0;
    end
